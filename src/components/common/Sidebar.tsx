      ...
      <div className="max-w-full mx-auto h-full flex items-center justify-between gap-4 relative z-10">
        ...
        <div className="flex items-center gap-2 flex-1">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-8 h-8 bg-gradient-to-br from-white via-zinc-200 to-zinc-500 rounded-lg flex items-center justify-center shadow-[0_0_15px_rgba(255,255,255,0.18)] group-hover:scale-110 transition-all duration-300 ease-in-out shrink-0">
              <span className="text-zinc-950 font-black text-lg">N</span>
            </div>
